...
namespace Game.Terrain.Noise
{
    public static partial class IcariaNoise
    {
        ...
        public static float GradientNoisePeriodic(
            float x,
            float y,
        ...
        public static (float x, float y) GradientNoisePeriodicVec2(
            float x,
            float y,
            in NoisePeriod period,
            int seed = 0
        ...
        static unsafe float InterpolateGradients2D(
            int llHash,
            int lrHash,
            int ulHash,
            int urHash,
        ...
        public static class Const
        {
            ...
            internal const int Offset = 0228125273,
                SeedPrime = 525124619,
                SeedMask = 0x0FFFFFFF,
                XPrime1 = 0863909317,
                YPrime1 = 1987438051,
